function varargout = imcontrast(handle)
...
%   $Revision: 1.1.8.16 $  $Date: 2007/06/04 21:10:53 $
...
% we expect either 0 or 1 output arguments
if (nargout > 1)
...
if badDisplayRange
    ...
    response = 'OK'; %response = displayWarningDialog(get(axHandle,'Clim'), imageRange);
...
% Create panel that contains data range, window edit boxes, and
% auto scaling
...
updateAllAndSaveInHistory(newClim);
    ...
    function reactToPropertyChanges
        ...
        %============================
        function updateTool(src,evt) %#ok<INUSL>
    ...
    function [startedWindowLevel,winLevelCbkStartId, winLevelCbkStopId] = ...
        ...
        %================================
        function winLevelStarted(obj,evt)  %#ok<INUSD>
            startedWindowLevel = true;
        end

        %================================
        function winLevelStopped(obj,evt) %#ok<INUSD>
            startedWindowLevel = false;
        end
    end

    %===================================
    function closeHistFig(obj,eventData) %#ok<INUSD>
    ...
    function setUpCallbacksOnDraggableWindow
        ...
        function minMaxLineDown(src,varargin)
            ...
            %====================================
            function minMaxLineMove(src,varargin) %#ok<INUSD>
        ...
        function minMaxPatchDown(src, varargin)
            ...
            %======================================
            function minMaxPatchMove(src, varargin) %#ok<INUSD>
    ...
    function hStatusLabel = createBottomPanel(parent)
        ...
        defaultMessage = sprintf('%s%s\n%s', ...
            ...
            'Hit ''Adjust Data'' to apply the changes to image data.');
        ...
        % Adjust Data Button
        buttonText = 'Adjust Data';
        
        hDummyText = uicontrol('units','pixels',...
            'style','text',...
            'visible','off',...
            'string',buttonText);
        ...
        %=====================================
        function adjustButtonCallback(obj,evt) %#ok<INUSD>
        ...
        %=====================================
        function adjustButtonPosition(obj,evt) %#ok<INUSD>
    ...
    %===============================
    function undoLastChange(obj,evt) %#ok<INUSD>
    ...
    %=============================
    function redoLastUndo(obj,evt) %#ok<INUSD>
        historyLength = size(climHistory, 1);
    ...
    %===============================
    function undoAllChanges(obj,evt) %#ok<INUSD>
