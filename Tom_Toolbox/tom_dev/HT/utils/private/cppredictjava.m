function [success] = ...
    cppredictjava(inputBasePairsVector,inputPointsVector,basePointsVector,pick,...
              inputImage,baseImage)
%CPPREDICTJAVA Predict match for a new control point.
%   CPPREDICTJAVA is called from Java to do control point prediction.
%
% success = 1 when a new point was added.
% success = 0 when no point was added.

%   Copyright 1993-2006 The MathWorks, Inc.
%   $Revision: 1.1.6.1 $  $Date: 2006/11/08 17:49:30 $
...
% assertions if Java code not calling cppredictjava correctly
