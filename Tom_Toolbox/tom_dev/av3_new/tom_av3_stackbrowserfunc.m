function varargout = tom_av3_stackbrowserfunc(varargin)
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @tom_av3_stackbrowserfunc_OpeningFcn, ...
                   'gui_OutputFcn',  @tom_av3_stackbrowserfunc_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
%%  Opening Function                                                   %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function tom_av3_stackbrowserfunc_OpeningFcn(hObject, eventdata, handles, varargin)
...
storage_av3_stackbrowser.resamplezval = 20;
storage_av3_stackbrowser.resamplexyval = 8;
...
storage_av3_stackbrowser.refstep = 1;
...
%%  Output Function                                                    %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function varargout = tom_av3_stackbrowserfunc_OutputFcn(hObject, eventdata, handles) 
