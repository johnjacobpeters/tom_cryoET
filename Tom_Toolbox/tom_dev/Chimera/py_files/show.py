     ...
     (
      {
       ...
       'path': '/fs/sun11/lv01/pool/pool-nickell2/scratch/classify_from_blue_gene/ml3d_split_two_5/refine_bo/model_1/start.spi',
       'rotation': (
         ( 1, 0, 0, ),
         ( 0, 1, 0, ),
         ( 0, 0, 1, ),
     ...
     (
      {
       ...
       'grid_id': '',
       'name': 'Iter_50_reconstruction.vol',
       'path': '/fs/sun11/lv01/pool/pool-nickell2/scratch/classify_from_blue_gene/ml3d_split_two_5/refine_bo/model_2/start.spi',
       'rotation': (
         ( 1, 0, 0, ),
         ( 0, 1, 0, ),
         ( 0, 0, 1, ),
     ...
     (
      {
       ...
       'grid_id': '',
       'name': 'Iter_50_reconstruction.vol',
       'path': '/fs/sun11/lv01/pool/pool-nickell2/scratch/classify_from_blue_gene/ml3d_split_two_5/refine_bo/model_3/start.spi',
       'rotation': (
         ( 1, 0, 0, ),
         ( 0, 1, 0, ),
         ( 0, 0, 1, ),
