...
function make_Align()
starName = '20210201_201810XX_ZYZrofilt.star'; %star file need to be checked
list=tom_starread(starName); 
...
% fill in the Align file 
    for i=1:length(list)
        ...
        Align(1,i).Shift.X = shifts(1,i)/2.62; %Shift of particle, will be filled by tom_av3_extract_anglesshifts
        Align(1,i).Shift.Y = shifts(2,i)/2.62;
        Align(1,i).Shift.Z = shifts(3,i)/2.62;
